...
export const InstantReceive = (): JSX.Element => {
  const navigate = useNavigate();
  const location = useLocation();
  const selectedCountry = location.state?.country || "Nigeria";

  return (
    <Card className="w-[430px] h-[932px] p-0 border-0">
      <CardContent className="relative h-[932px] bg-[#180e72] rounded-[30px] overflow-hidden p-0">
        ...
        <div className="absolute w-[277px] h-[253px] top-[344px] left-[76px]">
          ...
          <img
            ...
            alt={selectedCountry}
            src={`https://c.animaapp.com/majzuovzdPDWv4/img/${selectedCountry.toLowerCase()}-flag.png`}
          />
        </div>
